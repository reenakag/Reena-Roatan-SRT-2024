...
library(readr)
Consolidated_QUANT_Vax_Cards <- read_csv("Consolidated QUANT Vax Cards (no refuerzos, flu, vitA, varicella) - A+B Vax Cards MINUS Refuerzos, HepBs, Varicella (2).csv", 
    col_types = cols(date = col_date(format = "%d-%m-%y"), 
        dob = col_date(format = "%d-%m-%Y")))
#View(Consolidated_QUANT_Vax_Cards_no_refuerzos_flu_vitA_varicella_A_B_Vax_Cards_MINUS_Refuerzos_HepBs_Varicella_2_)
