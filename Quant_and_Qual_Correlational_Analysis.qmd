...
```
```{r}
#- distribution of preg score for island region (boxplots)
#- distribution of preg score for La Colonia vs. not
#- Vaccination score vs. vaccination location (somehow)
#- Vaccination score vs. perceived distance to CE (subset for only people that get vax at CE)
```
