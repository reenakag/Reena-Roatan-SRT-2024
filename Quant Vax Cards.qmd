...
library(readr)
Consolidated_QUANT_Vax_Cards <- read_csv("Consolidated QUANT Vax Cards POLIO SHIFTED - FINAL (shifted polios, deleted cols, etc) (2).csv", 
    col_types = cols(date = col_date(format = "%d-%m-%y"), 
        dob = col_date(format = "%d-%m-%Y")))
#View(Consolidated_QUANT_Vax_Cards_POLIO_SHIFTED_FINAL_shifted_polios_deleted_cols_etc_2_)
